const patientDetailController = require('../controller/patientController')
...
upload.single('file'),
  ...
  patientDetailController.addPatientDetail
);

router.post('/view', patientDetailController.viewPatientDetail)

router.post('/email', patientDetailController.viewPatientByEmail)
